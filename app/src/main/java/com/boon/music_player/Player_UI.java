...
public class Player_UI extends AppCompatActivity {
    ...
    TextView player_songTitle, startTime, stopTime, playerArtistName;
    SeekBar seekBar;
    BarVisualizer visualizer;
    ImageView PlayerImageView, clearButton;
    String songName, imageURL, artistName = "Unknowns";
    public static MediaPlayer mediaPlayer;
    int resID, sessionToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player_songTitle = findViewById(R.id.PlayerSongName);
        ...
        player_songTitle.setSelected(true);
        player_songTitle.setText(songName);
